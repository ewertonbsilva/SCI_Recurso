...
-- Copiando dados para a tabela sci_recurso.chamada_civil: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela sci_recurso.chamada_militar: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela sci_recurso.equipes: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela sci_recurso.logs_sistema: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela sci_recurso.turnos: ~0 rows (aproximadamente)
...
CREATE TABLE `vw_efetivo_disponivel` (
	`tipo` VARCHAR(1) NOT NULL COLLATE 'cp850_general_ci',
	...
	`status` VARCHAR(1) NOT NULL COLLATE 'cp850_general_ci',
